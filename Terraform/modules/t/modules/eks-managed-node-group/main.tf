...
resource "aws_iam_role_policy_attachment" "this" {
  for_each = var.create && var.create_iam_role ? toset(compact(distinct(concat([
    ...
    "${local.iam_role_policy_prefix}/AutoScalingFullAccess",
    "${local.iam_role_policy_prefix}/AmazonElasticFileSystemFullAccess",
    "${local.iam_role_policy_prefix}/ElasticLoadBalancingFullAccess",
